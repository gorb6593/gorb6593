...
public class OpenAPI {
	...
	public static void main(String[] args) throws IOException{
		   StringBuilder urlBuilder = 
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("-", "UTF-8")); /*ê³µê³µ?°?´?„°?¬?„¸?—?„œ ë°›ì? ?¸ì¦í‚¤*/
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("foodServicesPlaceNM","UTF-8") + "=" + URLEncoder.encode("?‹œ?…¸?¸ë³µì?ê´?", "UTF-8")); /*ê¸‰ì‹ê¸°ê?ëª?*/

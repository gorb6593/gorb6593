...
//구글이 제공하는 메시징서비스 FCM을 이용해서 데이터를 주고 받는 경우, 구글서비스를 요청해서 처리
/*
 ...
 * 메소드를 설정해서 get, post방식 설정할 수 있다.
 * JSON데이터나 스트링데이터 등을 response하도록 설정할 수 있다.
 * HttpURLConnection REST API 호출
 */
public class HttpURLConnectionTest {
	public static void main(String[] args) throws IOException {
		...
		//전송방식
		con.setRequestMethod("GET");//서버에서 리소드 가져오기
